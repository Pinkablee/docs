...
The **Asset Escrow system**, developed by [Cfx.re](https://cfx.re/) in partnership with [Tebex](https://www.tebex.io/), provides a reasonable alternative to obfuscation and IP locking. By ensuring purchase ownership, your content will, and can only run on the servers of your customers, nowhere else. On top of that, your resources will be encrypted to prevent your work from being leaked.
...
When attempting to purchase a resource from our Tebex store, you will be asked to login with your FiveM and discord account before you can proceed any further.
