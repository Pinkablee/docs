...
3. **Configure p-spawner:** Within the "p-spawner" resource, locate and open the "config.lua" file. Customize the configuration settings to your liking. Refer to the **Configuration Guide** for detailed instructions.
