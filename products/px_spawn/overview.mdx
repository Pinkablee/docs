...
![px_spawn preview](/images/spawn.png)
...
<CardGroup cols={2}>
  <Card title="Configuration" icon="sliders" href="/spawn/configuration">
    Adjust interaction, vehicles, and spawn behavior.
  </Card>
  <Card title="Exports" icon="code" href="/spawn/exports">
    Integrate spawning logic into other systems.
  </Card>
</CardGroup>